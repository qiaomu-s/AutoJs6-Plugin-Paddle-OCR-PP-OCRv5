...
USE_LITE_KERNEL(split, kHost, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(shuffle_channel, kARM, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(sparse_conv2d, kARM, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(prior_box, kARM, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(swish, kARM, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(calib_inplace, kARM, kFP16, kNCHW, fp16_to_fp32);
USE_LITE_KERNEL(calib_inplace, kARM, kFP16, kNCHW, fp32_to_fp16);
USE_LITE_KERNEL(elementwise_add, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(fusion_elementwise_add_activation, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(elementwise_mul, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(fusion_elementwise_mul_activation, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(elementwise_sub, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(fusion_elementwise_sub_activation, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(elementwise_div, kARM, kFP16, kNCHW, def_fp16);
USE_LITE_KERNEL(fusion_elementwise_div_activation, kARM, kFP16, kNCHW, def_fp16);
...
USE_LITE_KERNEL(sigmoid, kARM, kFP16, kNCHW, def);
...
USE_LITE_KERNEL(yolo_box, kARM, kFP16, kNCHW, def);
