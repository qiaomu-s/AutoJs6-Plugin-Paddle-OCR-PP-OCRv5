...
El complemento MonkeyKing6 Paddle OCR PP-OCRv5 proporciona a MonkeyKing6 deteccion de texto y reconocimiento de texto basados en PaddleOCR ONNX Runtime. Admite el modelo movil predeterminado, el modelo de servidor de alta precision y modelos de reconocimiento multilingues.
...
- Admite llamadas de MonkeyKing6 como `ocr.paddle.recognizeText(...)` y `ocr.paddle(...)`.
...
Para mas ejemplos de uso, consulta la seccion [Optical Character Recognition (OCR)](https://docs.monkeyking6.com/#/ocr) de la documentacion de MonkeyKing6.
...
* [CHANGELOG.md](https://github.com/SuperMonster003/MonkeyKing6-Plugin-Paddle-OCR-PP-OCRv5/blob/master/.changelog/CHANGELOG-es.md)
...
- Documentacion OCR de MonkeyKing6: https://docs.monkeyking6.com/#/ocr
